				...
				f = {
						...
						if (n.changeInput) {
							switch ((typeof n.changeInput + "").toLowerCase()) {
								...
								/*	o = $('<div class="fileuploader-input">' +
										  	...
										  	'<div class="fileuploader-input-button ui-input-btn ui-btn ui-shadow ui-corner-all ui-icon-photo-upload ui-btn-icon-left ui-nodisc-icon btn-transition"><span class="all-caps">' + f._assets.textParse(n.captions.button) + '</span></div>' +
										  '</div>');*/
					...
					thumbnails: {
						...
						create: function() {
							...
							l = p.find(n.thumbnails._selectors.list);
...
// feedback: function(options) { return 'Upload ' + (options.limit == 1 ? 'file' : 'files') + ' to upload'; },
